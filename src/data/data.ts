export const YouthHighwayData = {
  welcome: "Welcome to Youth Highway",
  vision: "To create a world where every young person has the literacy, support, and opportunity to thrive—empowered by a community that uplifts and believes in their potential.",
  mission: "Youth Highway is a 501(c)(3) nonprofit organization committed to improving youth literacy and overall well-being. Through education, outreach, and advocacy, we strive to inspire change and create a positive path forward for children and families in our community. We aim to educate the nation about the diverse challenges youth face today—and how we can make a difference, together.",
  about: {
    founder: "David Carmon",
    description: "Youth Highway is a youth-based charitable organization serving Sacramento and surrounding communities. We believe every child deserves to be seen, supported, and celebrated.",
    programs: [
      {
  ...
  support: {
    description: "As a registered 501(c)(3), your donation to Youth Highway is tax-deductible and directly benefits children and families in need. Your generous support doesn’t just help our youth—it strengthens our entire community. It also provides recognition for your business or organization, showing your commitment to social impact and community leadership.",
    callToAction: "Join us in making a difference. Your contribution helps us tell better stories, empower more youth, and create brighter futures.",
    donateLink: "(Insert Donation Button or Link)"
  }
};
